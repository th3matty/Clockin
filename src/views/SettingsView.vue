    ...
    <Layout>
      <div class="max-w-4xl mx-auto py-6 px-4">
        ...
        <div class="mb-8">
          ...
          <p class="text-gray-600 dark:text-gray-400 mt-1">Manage your profile and default working hours</p>
        </div>
        ...
        <div class="space-y-8">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            ...
            <div class="px-6 py-6">
              <!-- Avatar Upload -->
              <div class="mb-8">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Profile Photo</label>
                <AvatarUpload />
              </div>
              ...
              <form @submit.prevent="handleSettingsUpdate" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">How many days per week do you work?</p>
                  </div>
                </div>
