<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
    ...
    <div
      class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 items-center justify-center p-12">
      <div class="max-w-lg">
        <!-- SVG Illustration -->
        <div class="mb-8 flex justify-center">
          <img src="/src/assets/time-management.svg" alt="Time Management Illustration"
      ...
      <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
          ...
          <div class="lg:hidden mb-8">
            <div class="flex justify-center mb-4">
              <img src="/src/assets/time-management.svg" alt="Time Management Illustration" class="w-48 h-auto" />
            </div>
          </div>
        ...
        <form @submit.prevent="handleSubmit" class="bg-white dark:bg-gray-800 py-8 px-6 shadow-lg rounded-lg space-y-6">
          ...
          <div>
            ...
            <input id="email" v-model="formData.email" type="email" autocomplete="email" required :class="[
            ...
            ]" placeholder="Enter your email" :disabled="loading" @blur="touchedFields.email = true" />
          ...
          <div>
            ...
            <div class="relative">
              <input id="password" v-model="formData.password" :type="showPassword ? 'text' : 'password'"
                ...
                ]" placeholder="Enter your password" :disabled="loading" @blur="touchedFields.password = true" />
          ...
          <div class="text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
              ...
              <router-link to="/signup" class="font-medium text-primary-600 hover:text-primary-500 transition-colors">
                Sign up here
              </router-link>
            </p>
          </div>
